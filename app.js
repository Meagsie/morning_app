...
const CRAWLS = [
  ...
  {text:'Brunswick excursion: Nightingale Village → Tinning St galleries → Guglielmo Park → Siteworks/Blak Dot → Mr Kitly → A1 Bakery → CERES nursery', cat:'Small adventures'}
];
ROUTES.joy = function(){
